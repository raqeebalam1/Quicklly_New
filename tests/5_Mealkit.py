...
class TesROTIKIT(ui_test_class.UVXVXIVClass):
    ...
    def test_labelBisebileth(self):
        time.sleep(10)
        label = self.mealkit_page.get_attribute(IndianMealKit.labelbisilbeth, 'textContent')
        print(label)
        self.assertEqual(self.actual22, label)

    def test_labelDaalchawal(self):
        time.sleep(10)
        label = self.mealkit_page.get_attribute(IndianMealKit.labelDaalchawal, 'textContent')
        print(label)
        self.assertEqual(self.actual23, label)

    def test_labelDaalfry(self):
        time.sleep(10)
        label = self.mealkit_page.get_attribute(IndianMealKit.labelDaalfry, 'textContent')
        print(label)
        self.assertEqual(self.actual24, label)

    def test_labeldaalmakhni(self):
        time.sleep(10)
        label = self.mealkit_page.get_attribute(IndianMealKit.labelDaalmakhni, 'textContent')
        print(label)
        self.assertEqual(self.actual25, label)

    def test_labelGajarhalwa(self):
        time.sleep(10)
        label = self.mealkit_page.get_attribute(IndianMealKit.labelGajarhalwa, 'textContent')
        print(label)
        self.assertEqual(self.actual26, label)

    def test_labelMasalabhindi(self):
        time.sleep(10)
        label = self.mealkit_page.get_attribute(IndianMealKit.labelMasalabhindi, 'textContent')
        print(label)
