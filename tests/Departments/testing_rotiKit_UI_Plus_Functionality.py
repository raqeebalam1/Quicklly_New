...
class TesROTIKIT(ui_test_class.UVXVXIIIClass):
    ...
    actual4 = "Wheat Bhakri  "
    actual5 = "Fresh Tawa Roti"
    actual6 = "Masala Roti  "
    actual7 = "Juwar Rotla  "
    actual8 = "Methi Paratha  "
    actual9 = "Spinach Paratha  "
    actual10 = "Thepla"
    actual11 = "Coriander Mint Paratha  "
    actual12 = "Bhakhri"
    ...
    def test_labelWholeWheat(self):
        time.sleep(10)
        label = self.roti_page.get_attribute(RotiKit.wholewheatlabel, 'textContent')
        print(label)
        self.assertEqual(self.actual4, label)

    def test_labelRoti(self):
        time.sleep(10)
        label = self.roti_page.get_attribute(RotiKit.rotiLabel, 'textContent')
        print(label)
        self.assertEqual(self.actual6, label)

    def test_labelJuwarrotla(self):
        time.sleep(10)
        label = self.roti_page.get_attribute(RotiKit.labelJuwarRotla, 'textContent')
        print(label)
        self.assertEqual(self.actual7, label)

    def test_labelMeethi(self):
        time.sleep(10)
        label = self.roti_page.get_attribute(RotiKit.labelMeethi, 'textContent')
        print(label)
        self.assertEqual(self.actual8, label)

    def test_labelSpanichParatha(self):
        time.sleep(10)
        label = self.roti_page.get_attribute(RotiKit.ParathaLabel, 'textContent')
        print(label)
        self.assertEqual(self.actual9, label)

    def test_labelMintParatha(self):
        time.sleep(10)
        label = self.roti_page.get_attribute(RotiKit.labelMintParatha, 'textContent')
        print(label)
    ...
    #     # self.BactToPage()
    #     time.sleep(3)
    #     label = self.roti_page.get_attribute(RotiKit.BakhriLabel, 'textContent')
    #     print(label)
    #     self.assertEqual(self.actual12, label)
    #
    # def test_labelWhatWeDeliver(self):
    #     label = self.roti_page.get_attribute(RotiKit.whatweDeliver, 'textContent')
    #     print(label)
    #     self.assertEqual(self.actual14, label)
    #
    # def test_labelFresh(self):
    #     label = self.roti_page.get_attribute(RotiKit.FreshHomeMade, 'textContent')
    #     print(label)
    #     self.assertEqual(self.actual15, label)
    #
    # def test_labelPremium(self):
    #     label = self.roti_page.get_attribute(RotiKit.Premium, 'itextContent')
    #     print(label)
    #     self.assertEqual(self.actual16, label)
    # #
    # def test_labelFreeDelivery(self):
    #     label = self.roti_page.get_attribute(RotiKit.FreeDeivery, 'textContent')
    #     print(label)
    #     self.assertEqual(self.actual17, label)
    #
    # def test_labelWhatAreRotis(self):
    #     label = self.roti_page.get_attribute(RotiKit.WhatareRotis, 'textContent')
    #     print(label)
