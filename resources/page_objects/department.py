...
#//*[@id="searchhide"]/div[5]/div/div/div[1]/a
    ...
    def click_Homemade(self):
        element = self.driver.find_element_by_xpath('// *[ @ id = "searchhide"] / div[1] / div / div / div / div / a[3] / img')
        self.driver.execute_script("arguments[0].click();", element)

    def click_Homemade1(self):
        element = self.driver.find_element_by_css_selector('#searchhide > div.grocerySpecialSlider.clsFoodSpl.clslowspace > div > div > div > div > a:nth-child(3) > img')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def click_Nikita(self):
        element = self.driver.find_element_by_xpath('//*[@id="img_nikita-c-3"]')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def select_Cabbage(self):
        element = self.driver.find_element_by_xpath('//*[@id="shefdata"]/div[1]/div[5]/div/a')
        self.driver.execute_script("arguments[0].click();", element)

    def select_AloMattar(self):
        element = self.driver.find_element_by_xpath('//*[@id="shefdata"]/div[2]/div[5]/div/a')
        self.driver.execute_script("arguments[0].click();", element)

    def select_VegPulao(self):
        element = self.driver.find_element_by_xpath('//*[@id="shefdata"]/div[3]/div[5]/div/a')
        self.driver.execute_script("arguments[0].click();", element)

    def select_Shrikhand(self):
        element = self.driver.find_element_by_xpath('//*[@id="shefdata"]/div[4]/div[5]/div/a')
        self.driver.execute_script("arguments[0].click();", element)

    def select_SabudanaKhichri(self):
        element = self.driver.find_element_by_xpath('//*[@id="shefdata"]/div[5]/div[5]/div/a')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def click_IndianTiffin(self):
        element = self.driver.find_element_by_xpath('//*[@id="searchhide"]/div[2]/ul/li[2]/a')
        self.driver.execute_script("arguments[0].click();", element)

    def click_Kumaricafe(self):
        element = self.driver.find_element_by_xpath('//*[@id="tiffin-services"]/div/div[2]/a')
        self.driver.execute_script("arguments[0].click();", element)

    def click_AddPalak(self):
        element = self.driver.find_element_by_xpath('   // *[ @ id = "shefdata"] / div[1] / div[5] / div / a')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def click_LeftArrow1(self):
        element = self.driver.find_element_by_css_selector('#searchhide > div.grocerySpecialSlider.clsFoodSpl.clslowspace > div > div > i.left.slick-arrow > img')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def click_HouseHold(self):
        element = self.driver.find_element_by_xpath('//*[@id="searchhide"]/div[2]/div[1]/div/div/a[2]/img')
        self.driver.execute_script("arguments[0].click();", element)

    def click_HouseHold1(self):
        element = self.driver.find_element_by_css_selector('#searchhide > div.grocerySpecialSlider.clsGroceryCats > div.clsSliderCats.slick-initialized.slick-slider > div > div > a.category_link.slick-slide.slick-active.active > img')
        self.driver.execute_script("arguments[0].click();", element)
