...
class IndianGrocery(BasePage):
    ...
    def click_Biweekly2(self):
        element = self.driver.find_element_by_css_selector('#searchhide > section.productsection > div > div > div.organicproductcontent > div.divcustomtabpanels > ul > li.bi-weekly.tablinks > a')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def click_buildABox(self):
        element = self.driver.find_element_by_css_selector('#searchhide > section.productsection > div > div > div.organicproductcontent > div.divbuildbox > form > button')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def click_AddWholemillets(self):
        element = self.driver.find_element_by_xpath('//*[@id="searchhide"]/div[2]/div[3]/div/div[2]/div[3]/div[1]/a')
        self.driver.execute_script("arguments[0].click();", element)

    def click_AddBajra(self):
        element = self.driver.find_element_by_xpath(
            '//*[@id="searchhide"]/div[2]/div[3]/div/div[2]/div[3]/div[1]/a')
        self.driver.execute_script("arguments[0].click();", element)
    ...
    def click_Addtocartbutton(self):
